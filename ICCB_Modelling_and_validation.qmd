...
covs_current_expert <- subset(covs_current, c("bioclim_05", "bioclim_06", "bioclim_12", "bioclim_15"))
names(covs_current_expert) <- c("Max_temp_warmest_month", "Min_temp_coldest_month", "Annual_Precipitation", "Precipitation_seasonality")
...
usdm::vif(covs_current_expert)

usdm::vifstep(covs_current_expert)
