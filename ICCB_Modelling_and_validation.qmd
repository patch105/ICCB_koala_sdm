...
partial_response(glm_model_1, predictors = train_PB_covs_thinned[,predictors])
...
# Plot the partial responses
partial_response(glm_model_2, predictors = train_PB_covs_thinned[,pred])
...
train_PB_covs_scaled$Presence <- as.factor(train_PB_covs_scaled$Presence)
