...
inflated_response(glm_model_1, predictors = train_PB_covs_thinned[,pred], method = "stat3", lwd = 3, main='GLM') 
...
# Plot the partial responses
partial_response(glm_model_2, predictors = train_PB_covs_thinned[,pred], main='GLM')

# Plot inflated response curves:
inflated_response(glm_model_2, predictors = train_PB_covs_thinned[,pred], method = "stat3", lwd = 3, main='GLM') 
...
train_PB_covs_thinned$Presence <- as.factor(train_PB_covs_thinned$Presence)
...
partial_response(rf_1, predictors = train_PB_covs_thinned[,pred], main='Random Forest')

# Plot inflated response curves:
inflated_response(rf_1, predictors = train_PB_covs_thinned[,pred], method = "stat3", lwd = 3, main='Random Forest') 
