...
## Load future environmental data (SSP 3.70)
...
plot(
  predicted_raster_model_1,
  main = "Predicted Probability of Presence of Koalas in SEQ under Future Conditions"
)
...
plot(analog_fut, main = "Predicted Probability of Presence of Koalas in SEQ under Future Conditions")

novel_fut <- predicted_raster_model_1

values(novel_fut)[values(mess)>0] <- NA

plot(novel_fut, main = "Predicted Probability of Presence of Koalas in SEQ under Future Conditions")
